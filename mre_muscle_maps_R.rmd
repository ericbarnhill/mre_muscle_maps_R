...
print("Chart accidentally lost (but can easily be remade)")
```
...
```{r fig.height = 3.5, fig.width = 7}
source('muscle_print_histogram_comparison.R')
load(file.path(proj_path, "sample_histograms.RData"))
ls()
summary(sample_hist_on)
#print_histogram_comparison(data_tall, sample_hist_on, sample_hist_off)
